...
import com.dand.domain.SampleVO;
import com.dand.domain.Ticket;
...
//	@GetMapping(value = "/getSample")
	...
	@GetMapping(value = "/check", params = { "height", "weight" }, produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
